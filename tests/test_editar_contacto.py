...
def test_editar_contacto_nombre():
    ...
    gestor.editar_contacto(1, nombre='Pepito Pelaez')
...
def test_editar_contacto_email():
    ...
    gestor.editar_contacto(2, email='pedritoanimal@hotmail.com')
...
def test_editar_contacto_categoria():
    ...
    gestor.editar_contacto(3, categoria='Profesional')
...
def test_editar_contacto_nombre_extremo():
    ...
    gestor.editar_contacto(4, nombre=nombre_extremo)
...
def test_editar_contacto_email_extremo():
    ...
    gestor.editar_contacto(5, email=email_extremo)
