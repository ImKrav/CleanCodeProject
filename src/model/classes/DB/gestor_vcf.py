...
class GestorVCF:
    ...
    def exportar_contactos(self, archivo: str) -> None:
        """
        ...
        with SessionLocal() as db:
            contactos = db.query(Contacto).filter(Contacto.usuario_id == self.usuario.id).all()
    ...
    def importar_contactos(self, archivo: str) -> list[Contacto]:
        ...
        try:
            ...
            with SessionLocal() as db:
                for contacto in contactos_importados:
